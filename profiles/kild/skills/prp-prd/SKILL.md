---
name: prp-prd
description: Interactive PRD generator - problem-first, hypothesis-driven product spec. Use when the user wants to create a PRD, write a product or feature spec, scope a new product, or invokes the prp-prd skill.
---
...
Run: `the prp-plan skill .claude/PRPs/prds/{name}.prd.md`
