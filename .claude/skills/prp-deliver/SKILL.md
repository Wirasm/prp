...
Require the absolute plan path before continuing. For issue input, also require the verified published-plan URL; stop at the planner's publication blocker rather than beginning an implementation whose shared contract is missing.
